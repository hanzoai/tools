...
console.log("X_HANZO_LLM_PROVIDER:", Deno.env.get("X_HANZO_LLM_PROVIDER"));
console.log("HANZO_NODE_LOCATION:", Deno.env.get("HANZO_NODE_LOCATION"));
console.log("X_HANZO_APP_ID:", Deno.env.get("X_HANZO_APP_ID"));
